package com.merveadler.exception;
...
public enum ErrorType {
    ...
    KULLANICI_BULUNAMADI(3001,"kullanici bulunamadı",HttpStatus.BAD_REQUEST),
    ...
    BAKIYE_YETERSIZ(3003,"Bakiye yetersiz. Lütfen Bakiye Yükleyiniz",HttpStatus.BAD_REQUEST),
    KART_BILGILERINIZI_GIRINIZ(3003,"Kart bilgilerinizinizi giriniz",HttpStatus.BAD_REQUEST),
